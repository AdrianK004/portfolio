...
const skills = [
  {
    ...
    title: "Full-Stack",
    badge: "4+ years",
    text: "Building modern, scalable web apps with React, Tailwind and Vite on the frontend, and Node.js, Express, MySQL and Laravel on the backend — with strong Git-based workflows.",
  },
  {
    icon: JavaIcon,
    title: "Java",
    badge: "3+ years",
    text: "Solid foundation from high school through university, focused on object-oriented programming and application development, including a POS system for retail businesses.",
  },
  {
    icon: PythonIcon,
    title: "Python",
    badge: "1+ years",
    text: "Used across academic and personal projects — from small applications to image processing and data manipulation.",
  },
  {
    icon: CppIcon,
    title: "C / C++",
    badge: "Learning",
    text: "Deepening my systems programming skills with a focus on performance, memory and low-level control, on a strong programming foundation.",
  },
  {
    icon: CsharpIcon,
    title: "C#",
    badge: "Learning",
    text: "Expanding into C# with a focus on game development and interactive systems, adapting quickly to build creative, real-world projects.",
  },
  {
    icon: OopIcon,
    ...
    title: "OOP",
    badge: "Core skill",
    text: "Strong grasp of Object-Oriented Programming principles for building scalable, modular and maintainable software across technologies.",
  },
];
  ...
  return (
    <section id="skills" className="relative py-24 md:py-28">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading
          eyebrow="Expertise"
          title="Here's what I'm"
          highlight="good at"
          subtitle="The languages and technologies I use to bring ideas to life."
        />
          ...
          {skills.map((skill, i) => (
            ...
            >
              ...
              <div className="mb-4 flex items-center justify-between">
                <div className={`h-10 w-10 ${skill.tint ?? ""}`}>{skill.icon}</div>
                <span className="rounded-full border border-brand-400/30 bg-brand-500/10 px-2.5 py-1 text-xs font-semibold text-brand-300">
                  {skill.badge}
                </span>
              </div>
              <h3 className="font-display text-xl font-bold text-white">{skill.title}</h3>
              <p className="mt-3 text-sm leading-relaxed text-slate-400">{skill.text}</p>
            </motion.div>
          ))}
        </div>
      </div>
